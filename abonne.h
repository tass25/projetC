...
void handleBookBorrowing(Liste_Livre *Disponible, int bookCode);
void Emprunter_Livre(Liste_Abonne LAB, Liste_Livre *Disponible, Liste_Livre *En_Reparation, Abonne *A, int bookCode, int ident);
void sauvegarderEtatDesLivres(Liste_Livre *Disponible, Liste_Livre *En_Reparation);
void Envoyer_Livre_Reparation(Liste_Livre *Disponible, Liste_Livre *En_Reparation, Abonne *A, int x);
void Rendre_Livre(Liste_Abonne LAB, Liste_Livre *Disponible, Liste_Livre *En_Reparation, Abonne *A, int x, int ident);
